                                ...
                                <div class="inner">
                                    ...
                                    <div class="product-price-variant">
                                        <?php if (!empty($pro['variants'])): ?>
                                            <span class="price current-price">$<?= number_format($pro['variants'][0]['price'], 2) ?></span>
                                            <?php if (isset($pro['variants'][0]['old_price']) && $pro['variants'][0]['old_price'] > $pro['variants'][0]['price']): ?>
                                                <span class="price old-price">$<?= number_format($pro['variants'][0]['old_price'], 2) ?></span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <span class="price">No price available</span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if (!empty($pro['variants'])): ?>
                                        <div class="variants">
                                            <ul>
                                                <?php foreach ($pro['variants'] as $variant): ?>
                                                    <li>
                                                        <span><?= $variant['sku'] ?> - $<?= number_format($variant['price'], 2) ?></span>
                                                        <span> (số lượng :<?= $variant['stock_quantity'] ?> )</span>
                                                    </li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
