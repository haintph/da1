...
<div class="axil-best-seller-product-area bg-color-white axil-section-gap pb--0">
    <div class="container">
        <div class="product-area pb--50">
            <div class="section-title-wrapper">
                <span class="title-highlighter highlighter-primary"> <i class="far fa-shopping-basket"></i>Tháng
                    này</span>
                <h2 class="title">Siêu ưu đãi</h2>
            </div>
            <div
                    ...
                    <div class="axil-product product-style-three">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href="single-product.html">Diamond Necklace Earring</a>
                                </h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                    src="assets/images/product/jewellery/product-10.png" alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href="wishlist.html"><i
