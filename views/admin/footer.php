                                                                    ...
                                                                    <h4 class="timeline-title">Something
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/1.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/2.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/3.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/4.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/5.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/9.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/7.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="avatar-icon">
                                                                                    <img src="/../duan1/views/admin/assets/images/avatars/8.jpg"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left">
                                            <img width="42" class="rounded" src="/../duan1/views/admin/assets/images/avatars/1.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="widget-content-left">
                                        ...
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/1.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/2.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/3.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/4.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/5.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/6.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/7.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon">
                                                    <img src="/../duan1/views/admin/assets/images/avatars/8.jpg" alt="">
                                                </div>
                                            </div>
...
<script src="<?= ROOT_URL . 'views/admin/assets/scripts/jquery-3.2.1.min.js' ?>"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>

<script type="text/javascript" src="<?= ROOT_URL . 'views/admin/assets/scripts/main.js' ?>"></script>
<script type="text/javascript" src="<?= ROOT_URL . 'views/admin/assets/scripts/my_script.js' ?>"></script>
