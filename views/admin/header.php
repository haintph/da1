                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="<?= ROOT_URL .'views/admin/assets/images/avatars/2.jpg'?>"
                                                alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle"
                                                                        src="<?= ROOT_URL .'views/admin/assets/images/avatars/2.jpg'?>" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                    ...
                    <div class="app-sidebar__inner">
                        ...
                        <nav class="menu-left">
                            <ul>
                                ...
                                <li><a href="<?= ADMIN_URL . '?ctl=listpv' ?>" class="menu-item <?= ($current_url == ADMIN_URL . '?ctl=listpv') ? 'active' : '' ?>">Product Variant</a></li>
